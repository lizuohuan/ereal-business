...
/**
	 ...
	 * @throws Exception
     */
	public static Map<String,Date> getDateByTimeType(Integer timeType,Long time) throws Exception{
		//开始时间
	...
	public static void main(String[] args) {
		System.out.println( DateTimeHelper.getCurrentLastDayOfMonth(new Date()));
	}
